    ...
    <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-9 col-lg-6 col-xl-5">
                <img src="images/logoapple.jpeg" alt="Database Image" class="img-fluid" alt="Sample image">
            </div>
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="http://localhost/ALI/signup2.php" class="link-danger">Register</a></p>
            </div>
        </div>
    </div>
</section>
